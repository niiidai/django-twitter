...
class LikeCreateSerializer(BaseLikeSerializerforCreateAndCancel):
...
class LikeCancelSerializer(BaseLikeSerializerforCreateAndCancel):
    """
    This cancel method is self-defined and won't be called by
    serializer.save(). We need to use serializer.cancel() instead
    to call this cancel method.
    """
    def cancel(self):
